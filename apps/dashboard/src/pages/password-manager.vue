...
<template>
  <div class="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
    ...
    <div class="container mx-auto px-6 py-8 max-w-4xl">
          ...
          <div class="space-y-4">
            ...
            <div>
              <div class="flex items-center justify-between mb-2">
                ...
                <Button class="h-7" size="sm" variant="ghost" @click="showEditNameDialog = true">
      ...
      <Card class="mb-6">
        <CardHeader>
          ...
          <CardDescription> 更换新的设备标识。 </CardDescription>
        </CardHeader>
        <CardContent>
          <div class="space-y-4">
            <Button
    ...
    <DeviceRegisterDialog
      ...
      @update:model-value="(val) => (showResetDeviceDialog = val)"
    />
